...
## 신뢰성 자동 검증
CleanDNS는 GitHub Actions를 통해 주요 DNS 보안 기능을 **매일 자동 점검**합니다.

- 🔒 **DNSSEC**: 서명 유효성 검사 (example.com 기준)
- 🔒 **DNS over TLS**: 853 포트 연결 검사
- 🔒 **DNS over HTTPS**: POST 요청 RFC 8484 표준 방식

[![DNS Trust Check](https://github.com/onetwohour/CleanDNS/actions/workflows/dns-trust.yml/badge.svg)](https://github.com/onetwohour/CleanDNS/actions/workflows/dns-trust.yml)
